<div class="page-pedidos container">
  <div class="page-title">
    <div class="title_left">
      <h3>Matriculas del presente periodo actual</small></h3>
    </div>
  </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-4 col-sm-4 col-xs-4 col-lg-3">
        <button type="button" id="btnEditar" data-toggle="modal" data-target="#modalDetaPedido" class="btn btn-primary">Nueva Matr&iacute;cula</button>
    </div>
